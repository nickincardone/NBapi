import unittest
from nba.utils import cleanse_season, set_to_dict
...
class TestCleaseSeason(unittest.TestCase):
    ...
    def test_bad_input(self):
        self.assertRaises(ValueError, cleanse_season, ('a'))
        self.assertRaises(ValueError, cleanse_season, ('1700'))
        self.assertRaises(ValueError, cleanse_season, (3000))
        self.assertRaises(ValueError, cleanse_season, (1700))
        self.assertRaises(ValueError, cleanse_season, (1939))
        self.assertRaises(ValueError, cleanse_season, (113))
        self.assertRaises(ValueError, cleanse_season, ([1999]))
